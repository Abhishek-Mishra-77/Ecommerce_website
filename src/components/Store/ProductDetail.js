      ...
      <div className="product-detail">
        ...
        <div className="reveiw-content m-3">
          <div className="reveiw-content-detail">
            ...
            <h2>
              ₹ {data.price} {"     ,"}{" "}
              <small className="text-success">73% off</small>{" "}
            </h2>
          </div>
          <div className="review-contect-rating">
            ...
            <span className="text-secondary">
              13,148 ratings and 1,357 reviews
            </span>
          ...
          <div className="review-offer mt-3">
            ...
            />{" "}
            <small>
              <span className="text">Bank Offer</span> Flat ₹1,250 Off on HDFC
              Bank Credit Card EMI Trxns on orders priced between ₹15,000 to
              ₹39,999T&C
            </small>{" "}
            <br />
            <img
            ...
            />{" "}
            <small>
              <span className="text">Bank Offer</span> Flat ₹3,000 Off on HDFC
              Bank Credit Card EMI Trxns on orders priced between ₹40,000 to
              ₹49,999T&C
            </small>{" "}
            <br />
            <img
            ...
            />
            <small>
              <span className="text">Bank Offer</span> 10% instant discount on
              ICICI Bank Debit Cards, up to ₹250, on orders of ₹1750 and
              aboveT&C
            </small>{" "}
            <br />
            <img
